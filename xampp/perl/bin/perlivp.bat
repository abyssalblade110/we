...
#!perl
#line 29
    eval 'exec C:\Users\Jan.DESKTOP-O9DT0EI\Documents\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\Jan.DESKTOP-O9DT0EI\Documents\xampp\perl\bin\perl.exe';
